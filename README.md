...
![screenshot](https://github.com/bkarich/kb-watchparty/raw/master/public/screenshot_full.png)
...
- Clone this repo via `git clone git@github.com:bkarich/kb-watchparty.git`
