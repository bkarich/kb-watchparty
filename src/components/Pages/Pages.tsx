...
- You have the right to request deletion of your user data, in accordance with various laws governing data protection. Please contact support@klabausterbeere.xyz to request user data deletion.
...
I own a website and I'd like to have a link that generates a KB WatchParty room with a specific video already set. How do I do this?
----
You can link to https://watch.klabausterbeere.xyz/create?video=URL_HERE to do this!
...
export const DiscordBot = () => {
  return (
    <div>
      <Hero
        heroText={
          'Add the KB WatchParty Discord bot to your server to easily generate KB WatchParty links.'
        }
