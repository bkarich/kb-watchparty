  ...
  render() {
    ...
    return (
      <Modal open={true} onClose={closeSubscribe}>
        <Modal.Header>Subscribe to KB WatchParty Plus</Modal.Header>
        <Modal.Content image>
          ...
          <Modal.Description>
            ...
            <Table definition unstackable striped celled>
              <Table.Header>
                <Table.Row>
                  <Table.HeaderCell />
                  <Table.HeaderCell>KB WatchParty Free</Table.HeaderCell>
                  <Table.HeaderCell>KB WatchParty Plus</Table.HeaderCell>
                </Table.Row>
              </Table.Header>
